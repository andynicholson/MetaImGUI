...
function(setup_coverage_flags)
    if(ENABLE_COVERAGE)
        if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
            ...
            # -fprofile-update=atomic: Prevents race conditions in coverage counters when multithreading
            set(COVERAGE_COMPILER_FLAGS "-g -O0 --coverage -fprofile-arcs -ftest-coverage -fprofile-update=atomic" PARENT_SCOPE)
            set(COVERAGE_LINKER_FLAGS "--coverage" PARENT_SCOPE)

            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -O0 --coverage -fprofile-arcs -ftest-coverage -fprofile-update=atomic" PARENT_SCOPE)
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -O0 --coverage -fprofile-arcs -ftest-coverage -fprofile-update=atomic" PARENT_SCOPE)
    ...
    if(ENABLE_COVERAGE AND (CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang"))
        ...
        if(LCOV_PATH AND GENHTML_PATH)
            ...
            add_custom_target(coverage
                ...
                # Capture coverage data (ignore errors from race conditions)
