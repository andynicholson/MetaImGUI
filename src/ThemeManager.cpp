...
ThemeManager::Theme ThemeManager::s_currentTheme = Theme::Modern;
...
void ThemeManager::ApplyModernTheme() {
    ...
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.26f, 0.59f, 0.98f, 0.20f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.26f, 0.59f, 0.98f, 0.35f);
