...
### Fixed
-  remove gitsubmodule ecosystem from dependabot config

## [1.0.1] - 2026-01-17

### Fixed
-  add push triggers for main/develop branches to fix CI badge
-  remove outdated submodule check from dependency-review workflow

### Changed
-  updates to clarify dual licensing
