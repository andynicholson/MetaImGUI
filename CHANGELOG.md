...
### Fixed
-  replace ShellExecuteA with system() for URL opening on Windows
-  define WIN32_LEAN_AND_MEAN and NOMINMAX at CMake level
-  add missing headers for Windows and macOS CI builds

## [1.2.1] - 2025-12-10

### Changed
-  correct static analysis check count to 400+
-  add Static Analysis badge and update enforcement details
...
### Fixed
-  Add ImPlot setup to ThreadSanitizer and UndefinedBehaviorSanitizer jobs

## [1.1.2] - 2025-12-04

### Fixed
-  Add ImPlot setup to Windows Release build in release.yml
